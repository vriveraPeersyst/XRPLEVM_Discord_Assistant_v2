...
// -----------------
// Run Assistant Conversation with Context
// -----------------
// Accepts an array of conversation messages (each with a role and content).
export async function runAssistantConversation(
  assistantId: string,
  conversationMessages: { role: string, content: string }[]
): Promise<string> {
  // Create a thread (an API thread, not a Discord thread) using the conversation history.
